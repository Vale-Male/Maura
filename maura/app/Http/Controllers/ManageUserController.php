...
class ManageUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \Log::info($request);
        \Log::info('documentfield'.$request->custom_field_1);
        \Log::info('documentfield2'.$request->document);
        ...
        $request->validate([
            'custom_field_1' => 'file|max:'. (config('constants.document_size_limit') / 1000)
        ]);
        ...
        try {
            ...
            //upload document
            $document_name = $this->uploadFile($request, 'custom_field_1', 'documents');
            if (!empty($document_name)) {
                $user_details['custom_field_1'] = $document_name;
            }
