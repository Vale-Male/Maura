...
"payment_dues" => "Pago pendiente por compras. <br/> <small class='text-muted'> Basado en el límite de pago del proveedor. <br/> Mostrando pagos a ser pagados en 7 días o menos. </small>", /* modified */
...
"invoice_scheme" => "Esquema de venta significa formato de numeración de venta. Seleccione el esquema que se utilizará para esta ubicación comercial <small class='text-muted'> <i> Puede agregar un nuevo esquema de venta </ b> en configuración de venta </ i > </small> ",
"invoice_layout" => "Diseño de ventas para su ubicación comercial <small class='text-muted'> (<i> Puede agregar una nueva configuración de venta </ b> en <b> Configuración de venta <b> < /i>) </small> ",
"invoice_scheme_name" => "Dé un nombre breve y significativo al Esquema de venta",
"invoice_scheme_prefix" => "Prefijo para un esquema de venta. <br> Un prefijo puede ser un texto personalizado o un año actual. Ej .: # XXXX0001, # 2018-0002",
"invoice_scheme_start_number" => "Número de inicio para la numeración de la venta. <br> <small class='text-muted'> Puede hacer que sea 1 o cualquier otro número desde el que se inicie la numeración. </small>",
"invoice_scheme_count" => "Número total de ventas generadas para el esquema de ventas",
"invoice_scheme_total_digits" => "Longitud del número de venta excluyendo el prefijo de venta",
...
"print_receipt_on_invoice" => "Habilitar o deshabilitar la impresión automática de la venta al finalizar",
"receipt_printer_type" => "<i> Impresión basada en navegador </i>: mostrar el cuadro de diálogo Imprimir en el navegador con una vista previa de la venta <br/> <br/> <i> Usar impresora de recibos configurada </i>: seleccione una impresora térmica / recibo configurada para impresión",
