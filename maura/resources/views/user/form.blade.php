...
<div class="form-group ">
    {!! Form::label('custom_field_1',  __('purchase.attach_document') .' de '. $user_custom_field2 . ':') !!}
    {!! Form::file('custom_field_1', ['id' => 'upload_document', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
...
<div class="form-group ">
    {!! Form::label('custom_field_2',  __('purchase.attach_document') .' de '. $user_custom_field2 . ':') !!}
    {!! Form::file('custom_field_2', ['id' => 'upload_document2', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
    <small><p class="help-block">@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
        @includeIf('components.document_help_text')</p></small>
</div>
<div class="form-group ">
    {!! Form::label('custom_field_3',  __('purchase.attach_document') .' de '. $user_custom_field3 . ':') !!}
    {!! Form::file('custom_field_3', ['id' => 'upload_document3', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
    <small><p class="help-block">@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
        @includeIf('components.document_help_text')</p></small>
</div>
<div class="form-group ">
    {!! Form::label('custom_field_4',  __('purchase.attach_document') .' de '. $user_custom_field4 . ':') !!}
    {!! Form::file('custom_field_4', ['id' => 'upload_document4', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
    <small><p class="help-block">@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
        @includeIf('components.document_help_text')</p></small>
</div>
<div class="form-group col-md-3">
...
<div class="form-group col-md-3" style="visibility: hidden;display:none;">
