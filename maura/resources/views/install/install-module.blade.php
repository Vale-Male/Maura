              ...
              <form class="form" id="details_form" method="post" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="license_code" required class="form-control" value="web4free.in" id="license_code">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="login_username" required class="form-control" value="web4free.in" id="login_username">
                        </div>
                    </div>
